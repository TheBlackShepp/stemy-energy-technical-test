...
export const Fitler: React.FC = () => {
  ...
  return (
    <div className='flex w-full max-w-none md:max-w-lg mx-10 rounded bg-white'>
      <input className='w-full border-none bg-transparent px-4 py-1 text-gray-400 outline-none focus:outline-none' type='search' name='search' placeholder='Search...' onChange={handleChangeInput}/>
